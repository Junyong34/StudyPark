...
function initBizData() {
    ...
    chart.setData(bizData[0]);
    chart.draw();

    chart2.setData(bizData[0]);
    chart2.draw();

    chart3.setData(bizData[0]);
    chart3.draw();
}
...
function realtime() {
    ...
    chart2.setData(bizData[0]);
    chart2.draw();
    ActiveStackView2.initResize(bizData);

    chart3.setData(bizData[0]);
    chart3.draw();
    ActiveStackView3.initResize(bizData);
}
...
function alarmGen() {
    ...
    setTimeout(alarmGen, (Math.random() * (10 - 3 + 1) + 3) * 1000);
